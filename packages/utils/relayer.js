...
export class PaymentRelayer {
     ...
     */
    async submitToBundler(userOp, bundlerUrl) {
        const payload = {
            jsonrpc: '2.0',
            id: Date.now(),
     ...
     * @returns Transaction receipt
     */
    async submitToEntryPoint(userOp) {
 ...
 */
export function createUserOperation(sender, callData, paymasterAndData = '0x') {
    return {
        sender,
        nonce: '0x0',
        initCode: '0x',
